...
public class CalculatorControllerTest {
    ...
    @Test
    private void add_negativeNumbers_success() {
    ...
    @Test
    private void add_noNumbers_error() {
    ...
    @Test
    private void add_noQueryParams_error() {
    ...
    @Test
    private void substract_success() {
    ...
    @Test
    private void substract_negativeNumbers_success() {
        when(calculatorService.subtract(-5, -2)).thenReturn(-3);
        this.mockMvc.perform(get("/subtract?first=-5&second=-2")
                .accept(MediaType.APPLICATION_JSON))
            .andExpect(status().isOk())
    ...
    @Test
    private void subtract_noNumbers_error() {
    ...
    @Test
    private void subtract_noQueryParams_error() {
    ...
    @Test
    private void multiply_negativeNumbers_success() {
        when(calculatorService.multiply(-2, -3)).thenReturn(6);
        this.mockMvc.perform(get("/multiply?first=-2&second=-3")
                .accept(MediaType.APPLICATION_JSON))
            .andExpect(status().isOk())
    ...
    @Test
    private void multiply_noNumbers_error() {
    ...
    @Test
    private void multiply_noQueryParams_error() {
    ...
    @Test
    private void divide_negativeNumbers_success() {
        when(calculatorService.divide(-4, -2)).thenReturn(2);
        this.mockMvc.perform(get("/divide?first=-4&second=-2")
                .accept(MediaType.APPLICATION_JSON))
            .andExpect(status().isOk())
    ...
    @Test
    private void divide_noNumbers_error() {
    ...
    @Test
    private void divide_noQueryParams_error() {
